...
def signin(k,m,frm):
    ...
    if(m=="hoteltaj@123"):
        ...
        Button(frame1,text="Submit",command = lambda: [welcome(frame1,root,k),create(uservalue.get(),peoplevalue.get(),contactvalue.get())],padx=20,pady=10,font="20",bg="grey",fg="white").grid(row=3,column=0,rowspan = 2,columnspan = 2,sticky = SE)
